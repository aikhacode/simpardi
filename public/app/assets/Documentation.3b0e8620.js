...
\r
`,-1)),j=[P],z=u("<h5 data-v-12056e02>Structure</h5><p data-v-12056e02>Sakai consists of 2 main parts; the application layout and the resources. <i data-v-12056e02>App.vue</i> inside src folder is the main component containing the template for the base layout whereas required resources such as SASS structure for the layout are placed inside the <b data-v-12056e02>src/assets/</b> folder.</p><h5 data-v-12056e02>Layout Components</h5><p data-v-12056e02>Main layout is the template of the <i data-v-12056e02>App.vue</i>, it is divided into a couple of child components such as topbar, menu and footer. Here is template of the <i data-v-12056e02>App.vue</i> component that implements the logic such as menu state, layout modes and so on. </p><h5 data-v-12056e02>Menu</h5><p data-v-12056e02>Menu is a separate component defined in <i data-v-12056e02>AppMenu.vue</i> file based on PrimeVue MenuModel API. In order to define the menuitems, navigate to data section of <i data-v-12056e02>App.vue</i> file and define your own model as a nested structure using the <i data-v-12056e02>menu</i> property.</p><h5 data-v-12056e02>Dependencies</h5><p data-v-12056e02>Dependencies of Sakai are listed below and needs to be added to package.json.</p>",8),B=a(""),C=t(()=>e("code",null,`\r
{\r
    "primevue": "~3.11.0",\r
    "primeicons": "~5.0.0",\r
    "primeflex": "~3.1.2",\r
...
\r
`,-1)),F=[R,q];function J(i,K,O,Q,U,W){const s=l("code");return o(),n("div",_,[e("div",v,[e("div",m,[f,g,b,y,r((o(),n("pre",null,w)),[[s,void 0,void 0,{script:!0}]]),S,r((o(),n("pre",null,V)),[[s,void 0,void 0,{script:!0}]]),A,r((o(),n("pre",null,D)),[[s,void 0,void 0,{script:!0}]]),M,$,r((o(),n("pre",null,j)),[[s,void 0,void 0,{script:!0}]]),z,r((o(),n("pre",null,N)),[[s,void 0,void 0,{script:!0}]]),T,L,E,G,H,r((o(),n("pre",null,F)),[[s,void 0,void 0,{css:!0}]])])])])}var Y=d(h,[["render",J],["__scopeId","data-v-12056e02"]]);export{Y as default};
