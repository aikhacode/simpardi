import{_ as h,r as f,k as g,o as s,c as o,d as e,l as a,e as v,i as b,j as k,p as x,f as y,g as i,n as I,t as w}from"./index.cb2347e1.js";const S={data(){return{icons:null,filter:null}},mounted(){fetch("data/icons.json",{headers:{"Cache-Control":"no-cache"}}).then(n=>n.json()).then(n=>{let u=n.icons.filter(l=>l.icon.tags.indexOf("deprecate")===-1);u.sort((l,c)=>l.properties.name<c.properties.name?-1:l.properties.name<c.properties.name?1:0),this.icons=u})},computed:{filteredIcons(){return this.filter?this.icons.filter(n=>n.properties.name.indexOf(this.filter.toLowerCase())>-1):this.icons}}},t=n=>(x("data-v-6ed1b848"),n=n(),y(),n),P={class:"card"},z=t(()=>e("h3",null,"Icons",-1)),D=t(()=>e("p",null,[i("PrimeVue components internally use "),e("a",{href:"https://github.com/primefaces/primeicons",class:"font-medium"},"PrimeIcons"),i(" library, the official icons suite from "),e("a",{href:"https://www.primetek.com.tr",class:"font-medium"},"PrimeTek"),i(".")],-1)),V=t(()=>e("h5",null,"Download",-1)),C=t(()=>e("p",null,"PrimeIcons is available at npm, run the following command to download it to your project.",-1)),T=t(()=>e("code",null,`\r
