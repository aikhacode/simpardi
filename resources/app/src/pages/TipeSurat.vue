...
<div>
    <Toast/>
            ...
            <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id" 
                ...
                <template #header>
                    <div class="table-header flex flex-column md:flex-row md:justiify-content-between">
						<h5 class="mb-2 md:m-0 p-as-md-center">Manage Tipe Surat</h5>
                ...
                <Column field="tipe" header="Tipe" :sortable="true" style="min-width:10rem"></Column>
                <Column field="template" header="Template No" :sortable="true" style="min-width:10rem"></Column>
        ...
        <Dialog v-model:visible="productDialog" :style="{width: '450px'}" header="Kategori Details" :modal="true" class="p-fluid">
            <div class="field">
                <label for="tipe" class="mb-3">Tipe Surat</label>
                <InputText id="name" v-model.trim="product.tipe" required="true" autofocus :class="{'p-invalid': submitted && !product.tipe}" />
            </div>
            <div class="field">
                <label for="name">Template No Surat</label>
                <InputText id="name" v-model.trim="product.template" required="true" autofocus :class="{'p-invalid': submitted && !product.template}" />
                <small class="p-error" v-if="submitted && !product.template">Template No Surat harus diisi.</small>
            </div>
...
import ProductService from '@/service/TipesuratService';
...
export default {
    ...
    mounted() {
        ...
        this.productService.getTipeSurats().then((res) => {
             this.products = res
        });
    },
    methods: {
        ...
        validateInput(){
            return this.product.tipe && this.product.template
        },
        saveProduct() {
            this.submitted = true;
