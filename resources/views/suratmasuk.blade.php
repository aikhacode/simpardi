...
<head>
    ...
    <title>SIPARDI - SURAT MASUK</title>
...
<body>
	...
	<div class="d-flex justify-content-center flex-column">
		...
		<h5 class="text-center mb-2">LAPORAN REKAPITULASI SURAT MASUK</h5>
	...
	<table class='mx-auto table '>
		...
		<tbody>
			...
			<tr>
					...
					@foreach($header as $item)
						<td @class([
							'text-center' => ($item[1] == 'no') || ($item[1] == 'no_agenda') || ($item[1] == 'tgl_surat_masuk') || ($item[1] == 'tgl_surat')
							])>
						{{$key[$item[1]]}}</td>
					@endforeach
